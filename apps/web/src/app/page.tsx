...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white text-gray-900 overflow-hidden">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 sm:p-8 animate-fade-in-up">
            <div className="text-center mb-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-100 rounded-full mb-4">
                <span className="text-2xl">🪙</span>
                <span className="text-sm font-bold text-indigo-900">EXE TOKEN</span>
              </div>
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">
                Native Token Coming Soon
              </h2>
              <p className="text-gray-600">
                The EXE token will power the ExePay ecosystem with governance, staking, and fee discounts
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-2">
                <div className="flex-1 px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl text-gray-400 text-sm sm:text-base font-mono">
                  To be announced
                </div>
                <button
                  disabled
                  className="px-4 py-3 bg-gray-200 text-gray-400 rounded-xl font-semibold transition-all cursor-not-allowed"
                  title="Contract address will be available at launch"
                >
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-2">
                <div className="flex-1 px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl text-gray-400 text-sm sm:text-base">
                  Trading link will be available at launch
                </div>
                <button
                  disabled
                  className="px-4 py-3 bg-gray-200 text-gray-400 rounded-xl font-semibold transition-all cursor-not-allowed"
                  title="Buy link will be available at token launch"
                >
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="grid sm:grid-cols-3 gap-4 pt-6 border-t border-gray-200">
              <div className="text-center p-4 bg-indigo-50 rounded-xl">
                ...
                <div className="font-bold text-gray-900 mb-1">Governance</div>
                <div className="text-xs text-gray-600">Vote on protocol decisions</div>
              </div>
              <div className="text-center p-4 bg-purple-50 rounded-xl">
                <div className="text-2xl mb-2">💎</div>
                <div className="font-bold text-gray-900 mb-1">Staking</div>
                <div className="text-xs text-gray-600">Earn rewards by staking</div>
              </div>
              <div className="text-center p-4 bg-pink-50 rounded-xl">
                <div className="text-2xl mb-2">💰</div>
                <div className="font-bold text-gray-900 mb-1">Fee Discounts</div>
                <div className="text-xs text-gray-600">Lower transaction fees</div>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-xl">
              <div className="flex items-start gap-3">
                <span className="text-2xl">📢</span>
                <div>
                  <h4 className="font-bold text-indigo-900 mb-1">Stay Updated</h4>
                  <p className="text-sm text-indigo-800">
                    Follow us on <a href="https://x.com/exeinfra" target="_blank" rel="noopener noreferrer" className="font-semibold underline hover:text-indigo-600">Twitter/X</a> for token launch announcements and updates.
                  </p>
                </div>
              </div>
            </div>
